...
public class SpruceBarkItem extends TreebarkModElements.ModElement {
	@ObjectHolder("treebark:spruce_bark")
	public static final Item block = null;

	public SpruceBarkItem(TreebarkModElements instance) {
		super(instance, 2);
	}
