...
public class OakBarkItem extends TreebarkModElements.ModElement {
	@ObjectHolder("treebark:oak_bark")
	public static final Item block = null;

	public OakBarkItem(TreebarkModElements instance) {
		super(instance, 1);
	}
