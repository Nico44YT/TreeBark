...
public class JungleBarkItem extends TreebarkModElements.ModElement {
	@ObjectHolder("treebark:jungle_bark")
	public static final Item block = null;

	public JungleBarkItem(TreebarkModElements instance) {
		super(instance, 4);
	}
