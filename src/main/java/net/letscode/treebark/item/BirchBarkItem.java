...
public class BirchBarkItem extends TreebarkModElements.ModElement {
	@ObjectHolder("treebark:birch_bark")
	public static final Item block = null;

	public BirchBarkItem(TreebarkModElements instance) {
		super(instance, 3);
	}
