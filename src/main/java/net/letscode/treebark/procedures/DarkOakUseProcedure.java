...
public class DarkOakUseProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TreebarkModItems.DARK_OAK_BARK
				...
				&& ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Blocks.STRIPPED_DARK_OAK_LOG
						|| (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Blocks.STRIPPED_DARK_OAK_WOOD)) {
			if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Blocks.STRIPPED_DARK_OAK_LOG) {
				{
			...
			} else if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Blocks.STRIPPED_DARK_OAK_WOOD) {
				{
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TreebarkModItems.DARK_OAK_BARK) {
				...
				if (entity instanceof LivingEntity _entity)
					...
					.getItem() == TreebarkModItems.DARK_OAK_BARK) {
				if (!(new Object() {
					public boolean checkGamemode(Entity _ent) {
						if (_ent instanceof ServerPlayer _serverPlayer) {
							return _serverPlayer.gameMode.getGameModeForPlayer() == GameType.CREATIVE;
