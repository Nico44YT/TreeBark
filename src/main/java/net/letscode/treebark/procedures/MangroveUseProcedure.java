...
public class MangroveUseProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TreebarkModItems.MANGROVE_BARK.get()
				|| (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == TreebarkModItems.MANGROVE_BARK
						.get())
				&& ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.STRIPPED_MANGROVE_LOG
						|| (world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.STRIPPED_MANGROVE_WOOD)) {
			if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.STRIPPED_MANGROVE_LOG) {
				{
			...
			} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.STRIPPED_MANGROVE_WOOD) {
				{
					BlockPos _bp = new BlockPos(x, y, z);
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TreebarkModItems.MANGROVE_BARK
				...
				if (entity instanceof LivingEntity _entity)
					...
					.getItem() == TreebarkModItems.MANGROVE_BARK.get()) {
				if (!(new Object() {
					public boolean checkGamemode(Entity _ent) {
						if (_ent instanceof ServerPlayer _serverPlayer) {
							return _serverPlayer.gameMode.getGameModeForPlayer() == GameType.CREATIVE;
